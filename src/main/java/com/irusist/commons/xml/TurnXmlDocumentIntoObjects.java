...
public class TurnXmlDocumentIntoObjects {
    public static void main(String[] args) throws Exception {
        ...
        rules.add("plays/play", new ObjectCreateRule("com.irusist.commons.xml.util.Play"));
        ...
        rules.add("plays/play/characters/character", new ObjectCreateRule("com.irusist.commons.xml.util.Character"));
        rules.add("plays/play/characters/character", new SetNextRule("addCharacter", "com.irusist.commons.xml.util.Character"));
